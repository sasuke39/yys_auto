...
class DemonEncounterAssets: 
	...
	I_BOSS_SHISHENLU = RuleImage(roi_front=(1104,620,59,59), roi_back=(1104,620,59,59), threshold=0.8, method="Template matching", file="./tasks/DemonEncounter/boss/boss_boss_shishenlu.png")
