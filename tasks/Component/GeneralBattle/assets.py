...
class GeneralBattleAssets: 
	...
	# 新的预设图标
	I_PRESET_NEW = RuleImage(roi_front=(37,654,48,59), roi_back=(37,654,48,59), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralBattle/gb/gb_new_preset_all.png")
	# 准备 
