...
class AreaBossAssets: 
	...
	# # Image Rule Assets
	# # description
	# I_AREA_FIREONE = RuleImage(roi_front=(1104,494,100,100), roi_back=(1104,494,100,100), threshold=0.8, method="Template matching", file="./tasks/AreaBoss/res_fireone.png")
	# # 点击挑战
	# # I_FIRE = RuleImage(roi_front=(1108,492,100,100), roi_back=(1108,492,100,100), threshold=0.8, method="Template matching", file="./tasks/AreaBoss/res_fire.png")
	...
	# 点击挑战 
	I_FIRE = RuleImage(roi_front=(1104,494,100,100), roi_back=(1104,494,100,100), threshold=0.8, method="Template matching", file="./tasks/AreaBoss/res/res_fireone.png")
	# 地狱鬼王图标 
